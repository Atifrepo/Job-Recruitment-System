            ...
            <Router>
                <div>
                    ...
                    <div>
                        ...
                        <p><Link style={{backgroundColor: '#BDBDBD'}} className="link" to='/company/JobPost'>Post
                            Job</Link></p>
                        <p><Link style={{backgroundColor: '#BDBDBD'}} className="link" to='/company/MyPostJobs'>My Post
                            Job</Link></p>
                        <p><Link style={{backgroundColor: '#BDBDBD'}} className="link" to='/company/ViewStudents'> View
                            Students</Link></p>
                        <p><Link style={{backgroundColor: '#BDBDBD'}} className="link"
                                 to='/company/ViewApplicants'> View Applicants</Link></p>
